...
STYLE_METRICS = {
    ...
    "DEF": ["Passes per 90", "Forward Passes per 90", "Long Passes per 90",
            ...
            "Goals per 90", "Assists per 90", "Tackles per 90", "Interceptions per 90",
            "Clearances per 90", "Aerial Duels Won per 90", "Touches In Box per 90",
            "Recoveries per 90"],
    "MID": ["Passes per 90", "Key Passes per 90", "Forward Passes per 90", "Long Passes per 90",
            "Successful Crosses per 90", "Successful Dribbles per 90",
            "Shots per 90", "Goals per 90", "Assists per 90", "Touches In Box per 90",
            "Tackles per 90", "Recoveries per 90"],
    "FWD": ["Goals per 90", "Assists per 90", "Shots per 90", "Touches In Box per 90",
            "Successful Crosses per 90", "Successful Dribbles per 90", "Passes per 90",
            "Key Passes per 90", "Aerial Duels Won per 90", "Recoveries per 90"],
}
